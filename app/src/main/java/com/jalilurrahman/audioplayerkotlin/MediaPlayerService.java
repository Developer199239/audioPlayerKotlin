...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            ...
            audioList = StorageUtil.INSTANCE.loadAudio();
            audioIndex = StorageUtil.INSTANCE.loadAudioIndex();
    ...
    public void onDestroy() {
        ...
        StorageUtil.INSTANCE.clearCachedAudioPlaylist();
    }
    ...
    private void skipToNext() {
        ...
        //Update stored index
        StorageUtil.INSTANCE.storeAudioIndex(audioIndex);
    ...
    private void register_playNewAudio() {
        ...
        IntentFilter filter = new IntentFilter("com.jalilurrahman.audioplayerkotlin.PlayNewAudio");
